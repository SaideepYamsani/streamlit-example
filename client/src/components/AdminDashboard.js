...
function AdminDashboard() {
  ...
  const handleSaveOrderStatus = async (orderId) => {
    try {
      ...
      await axios.patch(`http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin/orders/${orderId}`, {
  ...
  const fetchData = async () => {
    try {
      ...
      const usersRes = await axios.get("http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin/users");
      setUsers(usersRes.data);
      const ordersRes = await axios.get("http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin/orders");
  ...
  const handleUpdateDetails = async (e) => {
    ...
    try {
      ...
      axios.defaults.headers.common["Authorization"] = "Bearer " + token;
      const res = await axios.put("http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/api/updateProfile", {
        id,
        username,
        email,
        phoneNumber,
  ...
  const handleDeleteUser = async (id) => {
    try {
      ...
      axios.defaults.headers.common["Authorization"] = "Bearer " + token;
      await axios.delete(`http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin/users/${id}`);
