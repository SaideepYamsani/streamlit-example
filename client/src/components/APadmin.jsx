...
export default function APadmin({ editingProduct, setEditingProduct }) {
  ...
  const fetchProductDetails = async () => {
    try {
      const response = await axios.get(`http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin-seller/products/${editingProduct}`);
      const { data } = response;
      setFormData({
        name: data.name || '',
        price: data.price || 0,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingProduct) {
        await axios.put(`http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin-seller/products/${editingProduct}`, formData);
        alert('Product updated successfully!');
      } else {
        await axios.post('http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin-seller/products', formData);
