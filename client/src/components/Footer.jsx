            ...
            <div className="container text-center text-md-start mt-5">
              <div className="row mt-3">
                ...
                <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                  ...
                  <hr className="mb-4 mt-0 d-inline-block mx-auto" style={{ width: '60px', backgroundColor: '#7c4dff', height: '2px' }} />
                  <p><a href="http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:3000/Blogs" className="text-white">Blog's</a></p>
                  <p><a href="http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:3000/FaQs" className="text-white">FAQs</a></p>
                  <p><a href="http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:3000/products" className="text-white">Products</a></p>
