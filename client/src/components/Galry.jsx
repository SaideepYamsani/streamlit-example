...
export default function Galry({
    ...
    useEffect(() => {
        ...
        const fetchAllData = async () => {
            try {
                const res = await http.get(`http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/admin-seller/getallproductimgs/${selectedProduct._id}`);
          ...
          <div className="col-12 col-lg-12 mt-2 col-md-12 col-sm-12 " style={{border:"none", boxShadow:"none"}}>
            <div className="card" id="cds" style={{border:"none", boxShadow:"none", borderRadius:"none"}} >
              ...
              <img
                ...
                src={
                  selectedImg === undefined
                    ? "http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/" + selectedProduct.image
                    : selectedImg
                }
                alt=""
              />
              ...
              <div className="imgContainer mb-2" id="imgContainer-resp" style={{display:"flex", justifyContent:"center"}}>
                {datas.map((img, index) => (
                  <img
                    src={"http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/" + img.image}
                    style={{
                      border:
                        selectedImg ===
                        "http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/" + img.image
                          ? "4px solid skyblue"
                          : "",
                          width:"5rem",
                          height:"5rem",
