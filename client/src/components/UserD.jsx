...
export default function UserD({
  ...
  const filteredBySearch = filteredProducts.filter((product) =>
    ...
    (product.spice && product.spice.toLowerCase().includes(searchTerm.toLowerCase())) ||
    (product.category && product.category.toLowerCase().includes(searchTerm.toLowerCase())) ||
    (product.sizeProduct && product.sizeProduct.toLowerCase().includes(searchTerm.toLowerCase()))
  );
                ...
                >
                  <div>
                    <img
                      src={
                        product._id
                          ? `http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/${product.image}`
                          : product.image
                      }
                      alt={product.name}
