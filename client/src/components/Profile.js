...
function Profile() {
    ...
    const fetchData = async () => {
      try {
        ...
        const productsRes = await axios.get(
          "http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/api/products"
        );
        setProducts(productsRes.data.products);

        const cartRes = await axios.get("http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/user/cart");
    ...
    if (sessionID) {
      (async () => {
        const res = await axios.get(
          `http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/user/session-status?session_id=${sessionID}`
        );
        ...
        if (res.data.status === "complete") {
          ...
          await axios.delete("http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/user/cart");
  ...
  const sendPostRequestCart = async (cart) => {
    ...
    if (productFlag) {
      await axios.post("http://ec2-3-21-35-199.us-east-2.compute.amazonaws.com:8000/user/cart", {
